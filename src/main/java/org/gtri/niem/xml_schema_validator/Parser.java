...
public class Parser extends SAXParser {
    public Parser(SchemaFullCheckingIndicator schemaFullCheckingIndicator, List<String> catalogURIs,
    ...
    public enum SchemaFullCheckingIndicator {
        SchemaFullChecking,
        NotSchemaFullChecking
    }
}
